...
class Resolver implements Expr.Visitor<Void>, Stmt.Visitor<Void> {
    ...
    public Void visitClassStmt(Stmt.Class stmt) {
        ...
        if (stmt.superclass != null) {
            beginScope();
            scopes.peek().put(
                "super", new Variable(null, VariableStatus.ACCESSED)
            );
        }

        beginScope();
        // Not accessing 'this' is not an error so always mark it as accessed
        scopes.peek().put("this", new Variable(null, VariableStatus.ACCESSED));
